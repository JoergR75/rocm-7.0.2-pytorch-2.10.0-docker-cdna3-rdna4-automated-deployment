#!/bin/bash
# ================================================================================================================
# ROCm 7.0.2 + OpenCL 2.x + PyTorch 2.10.0 (nightly for ROCm7) + Transformers + Docker Setup
# Compatible with Ubuntu 22.04.x and 24.04.x (Desktop & Server) — Ubuntu 20.04.x is no longer supported
# ================================================================================================================
# Description:
# This script automates the installation of AMD ROCm 7.0.2, PyTorch 2.10.0 (nightly for ROCm7), Transformers, and Docker
